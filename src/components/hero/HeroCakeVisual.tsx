...
export const HeroCakeVisual = () => (
  <div className="relative min-h-[28rem] overflow-hidden rounded-3xl border border-gold/45 bg-navy/35 p-2.5 shadow-[0_32px_90px_rgb(7_31_61_/_0.28)] backdrop-blur sm:min-h-[34rem] sm:p-4 lg:min-h-[42rem]">
    <div className="absolute inset-2.5 overflow-hidden rounded-[1.35rem] border border-gold/35 bg-[linear-gradient(145deg,#071F3D_0%,#0B2D55_58%,#FFF7E6_160%)] sm:inset-4">
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 text-center min-[360px]:p-5 sm:p-9">
        <div className="mx-auto max-w-md rounded-2xl border border-white/12 bg-navy/20 px-3 py-4 shadow-[0_18px_50px_rgb(3_18_38_/_0.36)] backdrop-blur-[2px] min-[360px]:px-4 sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-0">
          ...
          <h2 className="mt-2 break-words font-display text-[clamp(1.3rem,6vw,2.6rem)] font-bold leading-[1.08] text-white [overflow-wrap:anywhere] sm:mt-4">
            Three Milk Classical Cake
          </h2>
          <p className="mt-2 text-[0.78rem] font-semibold leading-relaxed text-white/86 min-[360px]:text-sm sm:mt-3 sm:text-base">
