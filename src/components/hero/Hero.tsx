...
export const Hero = () => (
  <section data-nav-theme="blue" className="relative overflow-hidden pb-10 pt-24 sm:pb-12 sm:pt-28 lg:pb-16">
    ...
    <div className="container-luxury grid items-center gap-8 lg:min-h-[520px] lg:grid-cols-[0.92fr_1.08fr]">
      <motion.div
