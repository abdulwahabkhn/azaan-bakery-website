...
export const Hero = () => (
  <section data-nav-theme="blue" className="relative min-h-screen overflow-hidden pb-20 pt-8">
    ...
    <div className="container-luxury grid min-h-screen items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
      <motion.div
